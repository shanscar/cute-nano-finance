        ...
        <div className="w-full max-w-2xl grid grid-cols-12 gap-4 relative">
          ...
          <div className="col-span-12 flex items-center justify-center gap-6">
            ...
            <img 
              src={connectorSvg} 
              alt="" 
              className="w-10 md:w-12 h-auto flex-shrink-0 -ml-6 md:-ml-7 -mr-8 md:-mr-9 z-30 pointer-events-none"
              aria-hidden="true"
            />
          ...
          <div className="col-span-12 flex items-center justify-center gap-6">
            ...
            <img 
              src={connectorSvg} 
              alt="" 
              className="w-10 md:w-12 h-auto flex-shrink-0 -ml-8 md:-ml-9 -mr-6 md:-mr-7 z-30 pointer-events-none transform scale-x-[-1]"
              aria-hidden="true"
            />
