      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 py-16">
        ...
        <div className="w-full max-w-2xl grid grid-cols-12 gap-4 relative">
          ...
          <div className="col-span-12 flex items-center justify-center gap-3 md:gap-6">
            ...
            >
              <span className="relative z-10 flex items-center gap-4">
                <span className="flex items-center justify-center w-24 h-24 rounded-xl border-4 border-black bg-black rotate-6 shadow-[6px_6px_0px_rgba(0,0,0,0.4)] transition-all duration-300 group-hover:scale-125 group-hover:-rotate-6 animate-[subtle-bounce]">
