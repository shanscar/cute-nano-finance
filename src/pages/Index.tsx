      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 py-16">
        ...
        <div className="w-full max-w-2xl grid grid-cols-12 gap-4 relative">
          ...
          <div className="col-span-12 flex items-center justify-center gap-3 md:gap-6">
            <Button
              className="w-[220px] md:w-[280px] h-32 text-lg font-bold rounded-3xl border-4 border-border bg-income text-income-foreground shadow-[-8px_-8px_0_rgba(0,0,0,1)] hover:shadow-[-12px_-12px_0_rgba(0,0,0,1)] hover:translate-y-2 hover:translate-x-[2px] transition-all duration-300 relative z-10 dotted-pattern"
