    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(135deg, hsl(48, 95%, 90%) 0%, hsl(48, 90%, 94%) 25%, hsl(210, 20%, 98%) 60%, hsl(210, 20%, 98%) 100%)' }}>
      ...
      <header className="flex items-center justify-between p-5 border-b-3 border-border">
        <Button
          variant="ghost"
          size="icon"
          className="h-16 w-16 rounded-xl border-4 border-black bg-badge-yellow/50 hover:bg-badge-yellow/70 shadow-[3px_3px_0px_rgba(0,0,0,1)] hover:shadow-[5px_5px_0px_rgba(0,0,0,1)] hover:scale-110 hover:-rotate-3 rotate-[-1deg] transition-all duration-200"
        >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-16 w-16 rounded-xl border-4 border-black bg-badge-pink/50 hover:bg-badge-pink/70 shadow-[3px_3px_0px_rgba(0,0,0,1)] hover:shadow-[5px_5px_0px_rgba(0,0,0,1)] hover:scale-110 hover:rotate-3 rotate-1 transition-all duration-200"
        >
